function dens8_function(K,dp,ep,kappa)
...
saving = 1;                       % Choose to save 0|1 (no|yes)
...
% Save Output
if saving == 1
    save(['Data/Outputs_K=',num2str(K),'_dp=',num2str(dp),'_ep=',num2str(ep),'_kappa=',num2str(kappa),'.mat'],...
